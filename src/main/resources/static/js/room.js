...
function goSelectRoomPage() {
    window.location.href = '/backend/room/selectRoomPage'
}
function goAddRoom() {
    window.location.href = '/backend/room/addRoom'
}
function goUpdateRoom() {
    window.location.href = '/backend/room/updateRoom'
}
function goSearchRoom() {
    window.location.href = '/backend/room/searchRoom'
}
function goListAllRoom() {
    window.location.href = '/backend/room/listAllRoom'
}
