...
CREATE TABLE members (
    ...
    member_password_salt   VARCHAR(64)   NOT NULL,                                          -- 會員密碼鹽值
    ...
    member_status          TINYINT       NOT NULL  DEFAULT 0  COMMENT '0:未驗證 1:已驗證',  -- 會員狀態
    CONSTRAINT pk_member_id PRIMARY KEY (member_id)
);

INSERT INTO members (member_email, member_password_hash, member_password_salt, member_name,       member_birthdate,  member_gender,
					 member_phone, member_address,       member_photo,         member_created_at, member_updated_at, member_last_login_time, member_status)
VALUES ('cja101g6gmail11111@gmail.com', 'password_hash', 'password_salt', '王小明', '1997-03-05', 0,
	    '0912345678', '台北市信義路100號3樓之一', NULL, '2023-07-01 10:15:30', '2025-04-10 14:20:00', '2025-05-19 18:45:10', 1),
	   ('cja101g6gmail22222@gmail.com', 'password_hash', 'password_salt', '林小華', '1998-03-05', 1,
		'0922333444', '台中市西屯路88號',         NULL, '2023-07-15 08:30:00', '2025-04-11 09:15:00', '2025-05-19 12:00:00', 1),
	   ('cja101g6gmail33333@gmail.com', 'password_hash', 'password_salt', '陳大文', '1999-03-05', 0,
		'0933444555', '高雄市中山路99號',         NULL, '2023-08-01 16:45:00', '2025-04-12 19:30:00', '2025-05-19 21:10:00', 1),
	   ('cja101g6gmail44444@gmail.com', 'password_hash', 'password_salt', '張怡君', '2000-03-05', 1,
	    '0966888777', '新竹市經國路66號',         NULL, '2023-08-15 11:00:00', '2025-04-13 13:20:00', '2024-05-19 17:55:00', 1),
	   ('cja101g6gmail55555@gmail.com', 'password_hash', 'password_salt', '周志強', '2001-03-05', 0,
	    '0977999111', '桃園市復興路10號',         NULL, '2023-09-01 09:00:00', '2025-04-14 10:30:00', '2025-05-19 15:40:00', 1),
	   ('cja101g6gmail66666@gmail.com', 'password_hash', 'password_salt', '蔡美麗', '2002-03-05', 0,
		'0988123456', '台南市永康區中正街5號',    NULL, '2023-09-15 07:50:00', '2025-04-15 08:30:00', '2025-05-19 20:00:00', 1),
	   ('cja101g6gmail77777@gmail.com', 'password_hash', 'password_salt', '何玉芬', '2003-03-05', 0,
		'0911888999', '台北市大安區光復南路11號', NULL, '2023-10-01 14:10:00', '2025-04-16 16:45:00', '2025-05-19 18:15:00', 1),
	   ('cja101g6gmail88888@gmail.com', 'password_hash', 'password_salt', '黃金龍', '2004-03-05', 1,
	    '0933222111', '嘉義市博愛路3段77號',      NULL, '2023-10-15 18:00:00', '2025-04-17 19:20:00', '2025-05-19 22:30:00', 1),
	   ('cja101g6gmail99999@gmail.com', 'password_hash', 'password_salt', '劉阿成', '2005-03-05', 1,
	    '0955667788', '台中市南區建國南路20號',   NULL, '2023-11-01 12:15:00', '2025-04-18 13:10:00', '2025-05-19 14:55:00', 0),
	   ('cja101g6gmail00000@gmail.com', 'password_hash', 'password_salt', '楊淑惠', '2006-03-05', 1,
	    '0988999777', '基隆市安樂區文德路88號',   NULL, '2023-11-15 09:05:00', '2024-04-19 11:30:00', '2025-05-19 16:45:00', 0);
...
VALUES ('暑期優惠',     '2025-07-01', '2025-08-31', '指定房型享 85 折優惠'),
       ('週末快閃特惠', '2025-09-06', '2025-09-08', '僅限週末訂房'),
       ('早鳥優惠',     '2025-10-01', '2025-10-15', '提前預訂享四人房 75 折折扣'),
       ('限時快閃',     '2025-09-15', '2025-09-17', '限時兩天，先搶先贏'),
       ('中秋促銷',     '2025-10-03', '2025-10-06', '歡慶中秋佳節海景房型優惠中'),
       ('春假專案',     '2025-03-10', '2025-03-20', '適合學生與家庭出遊'),
       (禮物',          '2025-12-24', '2025-12-26', '聖誕節高價位房型回饋價'),
...
-- 訂房訂單 room_reservation_order （陳薇淨）（已更新）
...
VALUES (1,  '2024-06-01 09:24:18', 2, '2025-05-22', '2025-07-09', 1, '備註', 5507, 194, 3690),
       (10, '2024-06-15 05:00:41', 0, '2025-05-31', '2025-06-19', 1, '備註', 4801, 495, 8053),
       (4,  '2024-07-09 01:52:22', 1, '2025-05-17', '2025-06-22', 4, '備註', 4820, 784, 9220),
       (1,  '2024-10-21 05:43:58', 4, '2025-06-04', '2025-07-04', 3, '備註', 7986, 131, 8192),
       (8,  '2024-11-12 21:03:18', 1, '2025-05-26', '2025-07-12', 4, '備註', 5746, 991, 7254),
       (5,  '2025-01-14 07:08:47', 2, '2025-06-02', '2025-07-02', 5, '備註', 6551, 454, 7784),
       (2,  '2025-01-24 15:37:12', 3, '2025-06-08', '2025-07-03', 2, '備註', 6175, 1000, 7100),
       (8,  '2025-03-18 01:15:54', 4, '2025-05-28', '2025-06-24', 1, '備註', 5833, 316, 4022),
       (9,  '2025-05-11 17:34:59', 1, '2025-05-21', '2025-07-01', 1, '備註', 3147, 675, 4075),
       (3,  '2025-07-16 11:21:14', 0, '2026-05-19', '2026-06-22', 4, '備註', 4603, 781, 4012);
*/
/* after */
INSERT INTO room_reservation_order (member_id, room_order_date, room_order_status, check_in_date, check_out_date, room_promotion_id, rv_remark, room_total_amount, rv_discount_amount, rv_paid_amount)
...
-- 訂房明細 room_reservation_detail （陳薇淨）（已更新）
...
VALUES (1, 101, 1, 2, 3000, 200, 2800),
(2, 201, 2, 3, 3500, 500, 3000),
(3, 301, 1, 2, 2800, 0, 2800),
(4, 401, 3, 4, 5000, 1000, 4000),
(5, 501, 2, 2, 3200, 200, 3000),
(6, 601, 1, 1, 2500, 100, 2400),
(7, 701, 2, 2, 3300, 300, 3000),
(8, 801, 3, 3, 4500, 500, 4000),
(9, 901, 1, 2, 2700, 200, 2500),
(10, 1001, 2, 2, 3400, 400, 3000);
*/
/* after */
INSERT INTO room_reservation_detail (room_reservation_id, room_id, room_type_id, guest_count, room_price, rv_discount_amount, rv_paid_amount)
...
-- 房型優惠價格 room_promotion_price （曾宸瑩）（已更新）
...
VALUES (1, 1, 3060),   -- 標準雙人房 85 折
       (1, 2, 4080),   -- 豪華海景雙人房 85 折
       (1, 3, 5100),   -- 豪華家庭房 85 折
       (1, 4, 6120),   -- 豪華海景家庭房 85 折
       (2, 1, 3240),   -- 標準雙人房 9 折
       (2, 2, 4320),   -- 豪華海景雙人房 9 折
       (3, 3, 4500),   -- 豪華家庭房 75 折
       (3, 4, 5400),   -- 豪華海景家庭房 75 折
       (4, 1, 2520),   -- 標準雙人房 7 折
       (5, 2, 4080),   -- 豪華海景雙人房 85 折
       (5, 4, 6120),   -- 豪華海景家庭房 85 折
       (5, 5, 7480),   -- 海景樓中樓家庭房 85 折
       (6, 1, 2160),   -- 標準雙人房 6 折
       (6, 2, 2880),   -- 豪華海景雙人房 6 折
       (7, 5, 7040),   -- 海景樓中樓家庭房 8 折
       (7, 6, 7680),   -- 行政豪華月牙套房 8 折
       (8, 2, 4080),   -- 豪華海景雙人房 85 折
       (8, 3, 5100),   -- 豪華家庭房 85 折
       (9, 1, 2700),   -- 標準雙人房 75 折
       (9, 2, 3600),   -- 豪華海景雙人房 75 折
       (9, 3, 4500),   -- 豪華家庭房 75 折
       (10, 1, 2880),  -- 標準雙人房 8 折
...
-- 各房型空房庫存量 room_type_availability （詹力臻）（已更新）
...
VALUES (0, '2026-1-1 08:00:00', '2026-1-1 09:00:00'),
	   (1, '2026-1-1 09:00:00', '2026-1-1 10:00:00'),
       (0, '2026-1-1 10:00:00', '2026-1-1 11:00:00'),
       (1, '2026-1-1 11:00:00', '2026-1-1 12:00:00'),
       (0, '2026-1-1 14:00:00', '2026-1-1 15:00:00'),
       (1, '2026-1-1 15:00:00', '2026-1-1 16:00:00'),
       (0, '2026-1-1 16:00:00', '2026-1-1 17:00:00'),
       (1, '2026-1-1 17:00:00', '2026-1-1 18:00:00');
*/
/* after */
INSERT INTO shuttle_schedule (shuttle_direction, shuttle_departure_time, shuttle_arrival_time) 
...
-- 接駁預約 shuttle_reservation （賴彥儒）（已更新）
CREATE TABLE shuttle_reservation (
	shuttle_reservation_id     INT      AUTO_INCREMENT  PRIMARY KEY,        -- 接駁預約編號 (PK)
    member_id                  INT      NOT NULL,                           -- 會員編號 (FK)
    room_reservation_id        INT      NOT NULL,                           -- 訂房編號 (FK)
...
VALUES (1, 1, '2025-01-01', 1, 0, 1, 1),
	   (2, 2, '2025-01-01', 1, 0, 3, 0),
       (3, 3, '2025-01-01', 1, 0, 5, 1),
       (4, 4, '2025-01-01', 1, 0, 7, 1),
       (5, 5, '2025-01-01', 1, 0, 9, 1),
       (6, 6, '2025-02-01', 1, 0, 2, 1),
       (7, 7, '2025-02-01', 1, 0, 4, 1),
       (8, 8, '2025-02-01', 1, 0, 6, 1),
       (9, 9, '2025-02-01', 1, 0, 8, 1),
       (10, 10, '2025-02-01', 1, 0, 10, 1);
*/
/* after */
INSERT INTO shuttle_reservation (member_id, room_reservation_id, shuttle_date, shuttle_schedule_id, shuttle_direction, shuttle_number, shuttle_reservation_status)
...
-- 座位 seat （王人慶）（已更新）
CREATE TABLE seat (
	seat_id      INT          AUTO_INCREMENT  PRIMARY KEY,       -- 座位編號
...
VALUES ('A1', 1), ('A2', 0), ('A3', 0), ('A4', 1), ('A5', 1), ('A6', 1), ('A7', 1), ('A8', 0), ('A9', 1), ('A10', 1), -- 1-10
	   ('B1', 0), ('B2', 0), ('B3', 0), ('B4', 1), ('B5', 1), ('B6', 1), ('B7', 1), ('B8', 0), ('B9', 1), ('B10', 1), -- 11-20
	   ('C1', 1), ('C2', 0), ('C3', 0), ('C4', 0), ('C5', 1), ('C6', 1), ('C7', 1), ('C8', 0), ('C9', 1), ('C10', 1), -- 21-30
       ('D1', 0), ('D2', 1), ('D3', 1), ('D4', 0), ('D5', 1), ('D6', 1), ('D7', 1), ('D8', 0), ('D9', 1), ('D10', 1), -- 31-40
       ('E1', 0), ('E2', 1), ('E3', 1), ('E4', 1), ('E5', 0), ('E6', 1), ('E7', 1), ('E8', 0), ('E9', 1), ('E10', 1), -- 41-50
       ('F1', 0), ('F2', 1), ('F3', 1), ('F4', 1), ('F5', 1), ('F6', 1), ('F7', 1), ('F8', 0), ('F9', 1), ('F10', 1), -- 51-60
       ('G1', 1), ('G2', 0), ('G3', 1), ('G4', 0), ('G5', 1), ('G6', 1), ('G7', 1), ('G8', 0), ('G9', 1), ('G10', 1), -- 61-70
       ('H1', 1), ('H2', 0), ('H3', 1), ('H4', 0), ('H5', 0), ('H6', 1), ('H7', 1), ('H8', 0), ('H9', 1), ('H10', 1), -- 71-80
       ('I1', 0), ('I2', 1), ('I3', 1), ('I4', 1), ('I5', 1), ('I6', 1), ('I7', 1), ('I8', 0), ('I9', 1), ('I10', 1), -- 81-90
       ('J1', 1), ('J2', 1), ('J3', 0), ('J4', 1), ('J5', 1), ('J6', 1), ('J7', 1), ('J8', 0), ('J9', 1), ('J10', 1); -- 91-100
*/
/* after */
INSERT INTO seat (seat_number, seat_status)
...
-- 接駁預約座位 shuttle_reservation_seat （賴彥儒）（已更新）
CREATE TABLE shuttle_reservation_seat (
	shuttle_reservation_id  INT  NOT NULL,  -- 接駁預約編號 (PK, FK)
    seat_id                 INT  NOT NULL,  -- 座位編號 (PK, FK)
    CONSTRAINT pk_shuttle_reservation_id_seat_id PRIMARY KEY(shuttle_reservation_id, seat_id),
...
-- 各接駁班次座位剩餘量 shuttle_seat_availability（王人慶）（已更新）
CREATE TABLE shuttle_seat_availability (
	shuttle_schedule_id  INT       NOT NULL,                 -- 接駁班次編號
	shuttle_date         DATE      NOT NULL,                 -- 日期
	...
	CONSTRAINT pk_shuttle_seat_availability_shuttle_schedule FOREIGN KEY(shuttle_schedule_id) REFERENCES shuttle_schedule (shuttle_schedule_id)
);

/* before
INSERT INTO shuttle_seat_availability (shuttle_schedule_id, shuttle_date, seat_quantity, seat_updated_at)
VALUES (1, '2026-1-1', 8 , '2026-1-1 07:30:00'),
       (2, '2026-1-1', 15, '2026-1-1 08:30:00'),
       (3, '2026-1-1', 40, '2026-1-1 09:30:00'),
       (4, '2026-1-1', 20, '2026-1-1 10:30:00'),
       (5, '2026-1-1', 33, '2026-1-1 13:30:00'),
       (6, '2026-1-1', 11, '2026-1-1 14:30:00'),
       (7, '2026-1-1', 44, '2026-1-1 15:30:00'),
       (8, '2026-1-1', 21, '2026-1-1 16:30:00');
*/
/* after */
INSERT INTO shuttle_seat_availability (shuttle_schedule_id, shuttle_date, seat_quantity, seat_updated_at)
...
-- 商品種類 product_category （陳吟瑄）（不須更新）
...
CREATE TABLE product_order (
    ...
    product_order_status  TINYINT       NOT NULL  COMMENT '0:成立 1:配送中 2:已取貨',  -- 商品訂單狀態
...
/* before
INSERT INTO product_order (member_id, coupon_id, product_order_amount, discount_amount, product_paid_amount,
                           payment_method, shipping_method, contact_address, contact_name, contact_phone,
                           product_order_status, product_order_time)
VALUES (1, 1, 1990, 50, 1940, 0, 0, '台北市信義路100號3樓之一', '王小明', '0912345678', 0, '2025-01-11 10:00:00'), -- 買產品1 1個
       (2, 1, 1400, 50, 1350, 1, 1, '台中市西屯路88號', '林小華', '0922333444', 1, '2025-01-31 11:30:00'), -- 買產品2 4個
	   (3, NULL, 150, 0, 2580, 0, 0, '高雄市中山路99號', '陳大文', '0933444555', 2, '2025-02-03 09:15:00'), -- 買產品3 1個
	   (4, 1, 999, 50, 949, 1, 1, '新竹市經國路66號', '張怡君', '0966888777', 0, '2025-03-04 14:00:00'), -- 買產品9 1個
	   (5, 1, 1200, 50, 1150, 0, 0, '桃園市復興路10號', '周志強', '0977999111', 1, '2025-04-05 16:45:00'), -- 買產品10 1個
	   (6, 4, 6858, 520, 6338, 1, 0, '台南市永康區中正街5號', '蔡美麗', '0988123456', 2, '2025-05-01 13:20:00'), -- 買產品5、6、7各2個
	   (7, 4, 4100, 520, 3580, 0, 1, '台北市大安區光復南路11號', '何玉芬', '0911888999', 0, '2025-05-04 17:10:00'), -- 買產品10 3個、產品2 1個、產品3 1個
	   (8, 4, 4500, 520, 3980, 1, 0, '嘉義市博愛路3段77號', '黃金龍', '0933222111', 1, '2025-05-10 12:00:00'), -- 買產品3 30個
	   (9, 1, 700, 50, 650, 0, 1, '台中市南區建國南路20號', '劉阿成', '0955667788', 2, '2025-05-10 09:30:00'), -- 買產品3 2個
	   (10, NULL, 350, 0, 350, 1, 1, '基隆市安樂區文德路88號', '楊淑惠', '0988999777', 0, '2024-05-11 18:45:00'); -- 買產品2 1個
*/
/* after */
INSERT INTO product_order (
	...
	(1, 1,     1990, 50,  1940, 0, 0, '台北市信義路100號3樓之一', '王小明', '0912345678', 0, '2025-01-11 10:00:00'), -- 買產品1 1個
	(2, 1,     1400, 50,  1350, 1, 0, '台中市西屯路88號',         '林小華', '0922333444', 1, '2025-01-31 11:30:00'), -- 買產品2 4個
	(3, NULL,  150,  0,   2580, 0, 0, '高雄市中山路99號',         '陳大文', '0933444555', 2, '2025-02-03 09:15:00'), -- 買產品3 1個
	(4, 1,     999,  50,  949,  1, 0, '新竹市經國路66號',         '張怡君', '0966888777', 0, '2025-03-04 14:00:00'), -- 買產品9 1個
	(5, 1,     1200, 50,  1150, 0, 0, '桃園市復興路10號',         '周志強', '0977999111', 1, '2025-04-05 16:45:00'), -- 買產品10 1個
	(6, 4,     6858, 520, 6338, 1, 0, '台南市永康區中正街5號',    '蔡美麗', '0988123456', 2, '2025-05-01 13:20:00'), -- 買產品5、6、7各2個
	(7, 4,     4100, 520, 3580, 0, 1, '台北市大安區光復南路11號', '何玉芬', '0911888999', 0, '2025-05-21 17:10:00'), -- 買產品10 3個、產品2 1個、產品3 1個
	(8, 4,     4500, 520, 3980, 1, 0, '嘉義市博愛路3段77號',      '黃金龍', '0933222111', 1, '2025-05-22 12:00:00'), -- 買產品3 30個
	(9, 1,     700,  50,  650,  0, 0, '台中市南區建國南路20號',   '劉阿成', '0955667788', 2, '2025-05-24 09:30:00'), -- 買產品3 2個
	(10, NULL, 350,  0,   350,  1, 0, '基隆市安樂區文德路88號',   '楊淑惠', '0988999777', 0, '2025-05-25 18:45:00'); -- 買產品2 1個
...
VALUES (7, 1, 5, 1990, '2025-01-08 12:04:57'),
       ...
       (4, 10, 2, 1200, '2025-05-16 19:04:49'),
...
VALUES (1, '潘筱涵', 'xiuying17@yan.tw',      '60413 新營士林路4號9樓',      '08-2910139',    0, '1990-12-30', '2023-01-01', NULL,         1),
	   (1, '黎俊宏', 'houjing@feng.tw',       '20869 彰化市育英街12號之0',   '0916-345792',   2, '1978-03-20', '2023-01-15', NULL,         1),
	   (2, '顧思穎', 'yangqiang@hotmail.com', '57698 中壢縣龍山寺巷61號8樓', '023 37594599',  0, '1985-06-28', '2023-02-01', NULL,         1),
	   (2, '段志宏', 'yanma@guo.net',         '769 白沙民富巷8號4樓',        '02-1787890',    0, '1998-01-11', '2023-02-15', NULL,         1),
	   (3, '王郁雯', 'fuchao@qiu.tw',         '23008 屏東大橋頭街8號之1',    '(04) 37142851', 2, '1983-04-27', '2023-03-01', NULL,         1),
	   (3, '王嘉玲', 'xiulan09@hotmail.com',  '965 臺東自由街3號之5',        '051 55900422',  1, '1988-12-07', '2023-03-15', NULL,         1),
	   (4, '陳詩涵', 'longjing@wen.com',      '754 桃園天母街8號7樓',        '0904522961',    2, '1968-11-08', '2023-04-01', NULL,         1),
	   (4, '崔志豪', 'duanna@hotmail.com',    '479 雲林縣中山巷63號1樓',     '00 5873176',    1, '1978-06-23', '2023-04-15', NULL,         1),
	   (5, '韓承翰', 'xqian@xiang.com',       '729 古坑縣頂福州巷193號之5',  '05 7082492',    0, '2004-01-17', '2023-05-01', NULL,         2),
	   (5, '王志宏', 'jiangjie@cheng.org',    '352 永康縣忠義路2段563號之7', '06 5993002',    2, '1998-11-13', '2023-05-15', '2023-12-31', 0);
*/
/* after */
INSERT INTO employee (department_id, employee_name, employee_email, employee_address, employee_mobile, employee_gender, employee_birthdate, employee_hiredate, employee_leavedate, employee_status)
...
-- 員工權限對應 employee_permission （陳吟瑄）（已更新）
...
VALUES (1, '2025-05-01 09:15:00', '登入系統'),
       (2, '2025-05-01 09:30:00', '查詢客戶資料'),
       (3, '2025-05-01 10:00:00', '修改訂單狀態'),
       (4, '2025-05-01 10:30:00', '新增商品'),
       (5, '2025-05-01 11:00:00', '刪除商品'),
       (1, '2025-05-01 11:30:00', '登出系統'),
       (2, '2025-05-01 13:00:00', '重設使用者密碼'),
       (3, '2025-05-01 13:30:00', '查詢客戶資料'),
       (4, '2025-05-01 14:00:00', '變更使用者權限'),
       (5, '2025-05-01 14:30:00', '登出系統');
*/
/* after */
INSERT INTO operation_log (employee_id, operation_time, log_description)
...
/* before
INSERT INTO feedback (member_id, feedback_time, answer1, answer2, answer3, answer4, answer5, rating)
VALUES (1, '2025-05-01 14:30:00', '非常滿意', '乾淨整潔', '服務親切', '環境安靜', '價格合理', 5),
       (2, '2025-05-02 15:00:00', '滿意', '房間稍小', '服務不錯', '早餐豐富', '價格尚可', 4),
       (3, '2025-05-03 16:15:00', '普通', '位置方便', '設備老舊', '服務中等', '價格偏高', 3),
       (4, '2025-05-04 11:00:00', '非常不滿意', '房間有味道', '服務冷漠', '隔音差', '不推薦', 1),
       (5, '2025-05-05 12:30:00', '非常滿意', '超出期待', '床很舒適', '早餐超好吃', 'CP值高', 5),
       (6, '2025-05-06 10:45:00', '滿意', '整體不錯', '電視太小', '服務還好', '價格合理', 4),
       (7, '2025-05-07 13:20:00', '普通', '還可以接受', '無特別亮點', '冷氣有點吵', '價格可接受', 3),
       (8, '2025-05-08 17:30:00', '不滿意', '地點不理想', '設施不齊', '退房慢', '不會再來', 2),
       (9, '2025-05-09 09:40:00', '非常滿意', '員工友善', '設施新穎', '乾淨又安靜', '值得推薦', 5),
       (10, '2025-05-10 18:10:00', '滿意', '整潔乾淨', '交通方便', '服務良好', '價格可接受', 4);
*/
-- after
...
/* before
INSERT INTO news (news_title, news_content, news_image, news_time)
VALUES ('春季旅遊優惠', '春季全館八折優惠，限時一週，敬請把握！', NULL, '2025-03-01 09:00:00'),
       ('母親節活動', '凡於母親節當週入住即贈送精美禮品一份！', NULL, '2025-05-01 10:00:00'),
       ('泳池維修公告', '5/10~5/15泳池進行維修，造成不便敬請見諒。', NULL, '2025-04-25 11:00:00'),
       ('全新房型開放預訂', '全新豪華雙人房正式開放預訂，數量有限！', NULL, '2025-04-10 08:30:00'),
       ('兒童遊樂區升級完成', '兒童遊樂區已完成升級，歡迎親子同遊。', NULL, '2025-04-15 12:00:00'),
       ('免費早餐延長至10點', '應顧客建議，早餐供應時間延長至上午10點。', NULL, '2025-04-05 07:00:00'),
       ('清明連假滿房公告', '4/4~4/6清明連假期間全館已無空房。', NULL, '2025-03-28 13:00:00'),
       ('櫻花季賞花行程開跑', '訂房即贈送櫻花季在地導覽一日遊行程！', NULL, '2025-03-20 09:00:00'),
       ('房客評價破千', '感謝支持，我們已累積超過1000則五星好評！', NULL, '2025-04-01 18:00:00'),
       ('網站改版通知', '全新官方網站上線，提供更便捷的訂房體驗。', NULL, '2025-05-10 10:30:00');
*/
-- after
INSERT INTO news (news_title, news_content, news_time)
VALUES ('春假出遊推薦', '適合學生與家庭出遊的春假專案，2025/03/10 至 2025/03/20。',              '2025-03-03 09:00:00'),
	   ('房客評價破千', '感謝支持，我們已累積超過1000則五星好評！',                              '2025-04-01 18:00:00'),
       ('免費早餐延長至10點', '應顧客建議，即日起早餐供應時間延長至上午10點。',                  '2025-04-05 07:00:00'),
       ('兒童遊樂區升級完成', '兒童遊樂區已完成升級，歡迎親子同遊！',                            '2025-04-15 12:00:00'),
       ('泳池維修公告', '5/10~5/15泳池進行維修，造成不便敬請見諒。',                             '2025-04-25 11:00:00'),
       ('網站改版通知', '全新官方網站上線，提供更便捷的訂房體驗！',                              '2025-05-10 10:30:00'),
       ('暑期優惠開跑', '指定房型享 85 折優惠，活動期間為 2025/07/01 至 2025/08/31。',           '2025-06-25 00:00:00'),
	   ('秋季旅行計畫推薦', '歡慶中秋佳節，景房限時優惠中，2025/10/03 至 2025/10/10。',          '2025-09-26 00:00:00'),
       ('週末快閃特惠', '僅限週末訂房，2025/09/06 至 2025/09/08 優惠開跑！',                     '2025-09-05 00:00:00'),
       ('限時快閃活動！', '限時兩天，先搶先贏！優惠期間：2025/09/15 至 2025/09/17。',            '2025-09-14 00:00:00'),
       ('早鳥優惠開跑', '提前預訂享雙人房 75 折折扣，優惠至 2025/10/01。',                       '2025-09-24 00:00:00'),
       ('中秋促銷限定', '歡慶中秋佳節，景房型優惠中，快來預訂！',                                '2025-10-03 00:00:00'),
       ('週年慶活動', '慶祝開館週年，推出多項感恩回饋，活動期間：2025/11/01 至 2025/11/03。',    '2025-11-01 00:00:00'),
       ('聖誕禮物大放送', '聖誕節首夜位房型回饋價！優惠期間：2025/12/24 至 2025/12/26。',        '2025-12-17 00:00:00'),
       ('元旦住宿優惠開跑', '2026 開年住房折扣，優惠期間：2026/01/01 至 2026/01/07，快來搶訂！', '2025-12-24 00:00:00');

-- DROP TABLE IF EXISTS news;


-- 輪播圖片 carousel_photo （陳薇淨）（不須更新）
